      ...
      <div className="flex flex-col mb-8  font-roboto">
        ...
        <div className="flex dark:text-white mt-3">
          ...
          <div className="flex flex-col ml-3 overflow-hidden">
            <span className="text-sm font-bold line-clamp-2 font-roboto ">
              {video?.title}
            </span>
            <span className="text-[12px] font-semibold mt-2 text-black/[0.5] dark:text-white/[0.7] flex items-center">
              {video?.author?.title}
              {video?.author?.badges[0]?.type === "VERIFIED_CHANNEL" && (
                <BsFillCheckCircleFill className="text-black/[0.5] dark:text-white/[0.5] text-[12px] ml-1" />
              )}
            </span>
            <div className="flex text-[12px] font-semibold text-black/[0.5] dark:text-white/[0.7] truncate overflow-hidden">
